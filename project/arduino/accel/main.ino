...
//#define WHO_AM_I_VAL 0x71 // MPU9250
#define WHO_AM_I_VAL 0x73 // MPU9255
...
const int myLed  = PC13;  // Set up pin 13 led for toggling
...
void setup()
{
  ...
  Serial.print(" I should be "); Serial.println(WHO_AM_I_VAL, HEX);
  ...
  display.setCursor(0,40); display.print(0x73, HEX);
  display.display();
  delay(1000);
#endif // LCD

  if (c == WHO_AM_I_VAL) // WHO_AM_I should always be 0x73 for MPU9255, 0x71 for MPU9250
  {
